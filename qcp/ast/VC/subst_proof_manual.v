...
Lemma proof_of_subst_var_return_wit_1_7 : subst_var_return_wit_1_7.
Proof. 
    pre_process.
    unfold list_Z_cmp in H1.
    rewrite H0 in H1.
...
Proof.
    pre_process.
    sep_apply store_term'_Var; [ | tauto].
    Intros var y.
    Exists y var.
    entailer!.
Qed. 
...
Proof. 
    pre_process.
    sep_apply store_term'_Const; [ | tauto].
    Intros y z.
    Exists y z.
    entailer!.
Qed. 
...
Proof. 
    pre_process.
    sep_apply store_term'_Apply; [ | tauto].
    Intros lt rt y z.
    Exists z y lt rt.
    entailer!.
Qed.
...
Proof. 
    pre_process.
    sep_apply store_term'_Quant; [ | tauto].
    Intros typ v b y z.
    Exists z y typ v b.
    entailer!.
Qed. 
...
Lemma proof_of_subst_term_return_wit_1_7 : subst_term_return_wit_1_7.
Proof. 
    pre_process.
    unfold list_Z_cmp in H1.
    rewrite H0 in H1.
